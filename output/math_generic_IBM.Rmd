...
\end{cases}
$$ 
Where $dx$ can either denote a negative exponential dispersal matrix $e^{-\lambda W_{j,k}}$, or an adjacency matrix  $U_{j,k}$. Each row of the resultant dispersal matrix is then normalised to produce conditional probabilities $O_{j,k}$:
